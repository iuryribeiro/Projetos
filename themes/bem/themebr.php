...
<div id="myPop" class="overlay">
    <div class="cadPessoa">
        ...
        <form action="<?= url("/cadastrar") ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="flex doc">
                <a id="openDoc">+Documentos</a>
                <a id="openEnd">+Endereços</a>
                <a id="openObs">+Observações</a>
            </div>
            <div class="flex send">
                <a href="">cancelar</a>
                <button>Cadastrar</button>
                <a href="">salvar e <br> criar outro</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="green t2 container">
            ...
            <div class="flex ip">
                ...
                <a href="<?= url("/listagem-notas"); ?>">Cadastros</a>
            </div>
            <div class="hr2"></div>
            <div class="flex ip">
        ...
        <div class="painel flex">
            ...
            <div class="img flex">
                <ul class="ball">+
                    <ul>
                        <li>
                            <a href="<?= url("/listagem-notas"); ?>"><img src="<?= theme("/assets/images/custom+.svg") ?>">Nota
                                Digital</a>
                        </li>

                        <li onclick="openPop()">
                            <a><img src="<?= theme("/assets/images/person2.png") ?>">Cadastrar Cliente</a>
                        </li>

                        <li>

                            <a href=""><img src="<?= theme("/assets/images/car.svg") ?>">Rastreio de Encomendas</a>
                        </li>
                    </ul>
                </ul>
